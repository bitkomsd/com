                ...
                o = (n("c5f6"), {
                    data: function() {
                        return {
                            ...
                            notyText: null,
                            currency: "USD",
                            malenameusual: new Array("Oliver", "Lucas", "Ethan", "Noah", "James", "William", "Henry", "Alexander", "Daniel", "Matthew", "David", "Joseph", "Thomas", "Charles", "Robert", "Jack", "George", "Oscar", "Leo", "Felix", "Max", "Ruben", "Oscar", "Victor", "Julian", "Adrian", "Sebastian", "Simon", "Peter", "Andrew", "Mark", "John", "Robert", "Michael", "Christopher", "Joshua", "Daniel", "Samuel", "Benjamin", "Jonathan", "Nathaniel", "Patrick", "Ryan", "Kevin", "Brian", "Jason", "Eric", "Adam", "Albert", "Frank", "Walter", "Louis", "Arthur", "Harry", "Alfred", "Paul", "Stephen", "Nicholas", "Anthony", "Philip"),
                            lastnameusual: new Array("Smith", "Jones", "Williams", "Brown", "Taylor", "Davies", "Wilson", "Evans", "Thomas", "Roberts", "Johnson", "Walker", "Wright", "Robinson", "Thompson", "White", "Hughes", "Edwards", "Green", "Lewis", "Wood", "Harris", "Martin", "Jackson", "Clarke", "Davies", "Cooper", "Morris", "King", "Lee", "Hill", "Ward", "Turner", "Parker", "Collins", "Edwards", "Stewart", "Mitchell", "Cook", "Rogers", "Morgan", "Peterson", "Gray", "Reed", "Bell", "Murphy", "Bailey", "Rivera", "Cooper", "Richardson", "Cox", "Howard", "Ward", "Torres", "Peterson", "Gray", "Ramirez", "James", "Watson", "Brooks", "Kelly", "Sanders", "Price", "Bennett", "Barnes", "Ross", "Henderson", "Coleman", "Jenkins", "Perry", "Powell", "Long", "Patterson", "Hughes", "Flores", "Washington", "Butler", "Simmons", "Foster", "Gonzales", "Bryant", "Alexander", "Russell", "Griffin", "Diaz", "Hayes", "Myers", "Ford", "Hamilton", "Graham", "Sullivan", "Wallace"),
                            femalenameusual: new Array("Emma", "Mia", "Sophia", "Isabella", "Charlotte", "Amelia", "Harper", "Evelyn", "Abigail", "Emily", "Elizabeth", "Victoria", "Grace", "Lily", "Zoe", "Alice", "Chloe", "Ella", "Eva", "Lucy", "Mila", "Nora", "Ava", "Lara", "Maya", "Lena", "Stella", "Clara", "Sarah", "Hannah", "Anna", "Julia", "Maria", "Sophie", "Olivia", "Jessica", "Samantha", "Rachel", "Rebecca", "Emma", "Natalie", "Catherine", "Eleanor", "Caroline", "Anne", "Mary", "Catherine", "Elizabeth", "Jane", "Susan", "Dorothy", "Helen", "Ruth", "Martha", "Alice", "Frances", "Lillian", "Edith", "Mildred", "Grace", "Rose", "Marie", "Louise", "Patricia", "Deborah", "Sharon", "Nancy", "Karen", "Betty", "Donna", "Carol", "Linda", "Barbara", "Joan", "Cynthia", "Kathleen", "Sandra", "Christine", "Paula", "Angela", "Teresa", "Diana", "Jacqueline", "Lori", "Tracy", "Kimberly", "Michelle", "Amanda", "Heather", "Amy", "Nicole", "Melissa", "Rebecca", "Laura", "Lisa", "Pamela", "Denise", "Emily", "Victoria", "Lily", "Lucy", "Julia", "Sophie", "Jessica", "Rebecca", "Victoria", "Catherine", "Laura"),
                            lastnamefusual: new Array("Möller", "Weiß", "Jung", "Hahn", "Vogel", "Friedrich", "Günther", "Berger", "Winkler", "Beck", "Lorenz", "Baumann", "Franke", "Durand", "Leroy", "Laurent", "Michel", "Garcia", "Lopez", "Jimenez", "Ruiz", "Moreno", "Alvarez", "Alonso", "Navarro", "Torres", "Gallo", "Conti", "Mancini", "Moretti", "Barbieri", "Mariani", "Grassi", "Serra", "Palmieri", "Silvestri", "Gatti", "Caputo", "Neri", "Caruso", "Silvestri", "Sala", "Greco", "Jimenez", "Gomez", "Gomez", "Garcia", "Thomas", "Dubois", "Bernard", "Martin", "Kraus", "Winter", "Ludwig", "Simon", "Baumann", "Beck", "Winkler", "Berger", "Günther", "Keller", "Friedrich", "Scholz", "Lang", "Peters", "Fuchs", "Kaiser", "Huber", "Mayer", "Walter", "König", "Herrmann", "Maier", "Schulz", "Lehmann", "Meier", "Krause", "Schmitz", "Werner", "Schmitt", "Lange", "Hartmann", "Hofmann", "Krüger"),
                    ...
                    methods: {
                        randName: function(e, a) {
                            var n = Math.random();
                            return n < .25 ? (this.currency = "USD", this.randomNameMale() + " " + e) : n < .5 ? (this.currency = "USD", this.randomNameFemale() + " " + a) : n < .75 ? (this.currency = "USD", this.randomNameMaleEN() + " " + e) : n < 1 ? (this.currency = "USD", this.randomNameFemaleEN() + " " + a) : void 0
                        },
                        ...
                        toogleCurrency: function(e) {
                            return "USD" === e ? "$".concat(this.$numberWithSpaces((this.randSum / this.usdKurs).toFixed(2), "en"), "&nbsp; ").concat(this.$numberWithSpaces(this.$geoUpsellPrice(this.randSum))) : "USD" === e ? "".concat(this.$numberWithSpaces(this.randSum), "&nbsp;USD ").concat(this.$numberWithSpaces(this.$geoUpsellPrice(this.randSum))) : void 0
                        },
                        showAniToast: function(e) {
                            this.notyText = "<div>\n                          ".concat(this.randName("withdrew and received", "withdrew and received"), "\n                          <strong>\n                            ").concat(this.toogleCurrency(this.currency), "\n                          </strong>\n                        </div>"), this.toastAniClass = "animated fadeIn shadow wtoast float-right notificationNewTH mx-0 mt-0 mb-1 pr-0 px-0 pr-1"
                        },
                        runToast: function() {
                            var e = this;
