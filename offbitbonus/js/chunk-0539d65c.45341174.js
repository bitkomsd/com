        ...
        9894: function(e, a, n) {
            ...
            var t = function() {
                ...
                o = (n("c5f6"), {
                    data: function() {
                        return {
                            usdKurs: 100, // updated exchange rate (1 USD = 100 RUB, for example)
                            randSum: Number(),
                            ...
                            notyText: null,
                            currency: "USD",
                            // Replaced Russian names with English ones
                            ...
                            // English arrays (kept for reference but not used, we replaced the above)
                    ...
                    methods: {
                        ...
                        showAniToast: function(e) {
                            ...
                            this.toastAniClass = "animated fadeIn shadow wtoast float-right notificationNewTH mx-0 mt-0 mb-1 pr-0 px-0 pr-1"
                        },
                        runToast: function() {
                            var e = this;
