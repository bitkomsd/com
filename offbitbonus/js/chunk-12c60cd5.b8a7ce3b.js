            ...
            var f, y = {
                    data: function() {
                        return {
                            ...
                            paymentMethod: localStorage.getItem("/offbitbonus/paymentMethod") || "Bank card (USA)"
                        }
                    },
                    computed: {
            ...
            var N = {
                    ...
                    computed: {
                        ...
                        convertedAmountRUB: function() {
                            return 1 == this.$store.getters.kurs ? this.$store.getters.rescueMoney + " USD" : this.$numberWithSpaces(this.$geoUpsellPriceOnlyNum(this.$store.getters.rescueMoney, "usd")).replace(/ *\([^)]*\) */g, "")
                        },
                        ...
                        paymentMethod: function() {
                            return this.$store.getters.paymentMethod || "Bank card (USA)"
                        },
